...
import deprecated = require('depd')('loopback-datasource-juggler');
import g = require('strong-globalize')();

/**
 * Hooks object
 */
exports = class Hookable {
  /**
   * List of hooks available
   */
  static readonly afterInitialize = null;
  static readonly beforeValidate = null;
  static readonly afterValidate = null;
  static readonly beforeSave = null;
  static readonly afterSave = null;
  static readonly beforeCreate = null;
  static readonly afterCreate = null;
  static readonly beforeUpdate = null;
  static readonly afterUpdate = null;
  static readonly beforeDestroy = null;
  static readonly afterDestroy = null;
   ...
   */
  trigger(actionName: string, work: Function, data: unknown, callback: Function) {

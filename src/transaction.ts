 ...
 */
exports = class TransactionMixin {
   ...
   * ```
   *
   * @param options Options to be passed upon transaction.
   *
   ...
   */
  beginTransaction(options, cb = utils.createPromiseCallback()): Promise<unknown> | undefined {
    if (Transaction) {
